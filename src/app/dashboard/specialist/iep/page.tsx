  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-3xl font-black text-[#0B2341] mb-6">IEP Management</h1>
        <div className="bg-white border border-gray-100 rounded-2xl p-12 text-center shadow-sm">
          <div className="text-4xl mb-4">📋</div>
          <h3 className="text-xl font-bold text-[#0B2341] mb-2">Coming Soon</h3>
          <p className="text-gray-500 max-w-md mx-auto">Manage individualized education programs and goals easily.</p>
        </div>
      </div>
    </div>
  )
